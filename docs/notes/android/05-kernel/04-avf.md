...
Google 计划推动 pKVM 获得 SESIP（Security Evaluation Standard for IoT Platforms）认证（具体时间与结果待确认）。
...
pKVM 基于开源代码，具有较高的透明度和可审计性，若获得认证将进一步增强其可信度。
...
### 5.3 [CVE-2025-22413](../../../cves/entries/CVE-2025-22413.md) 案例分析
...
此案例说明即使是高度安全的 hypervisor 实现，状态管理逻辑仍是重要的审计目标。（注：此为近期 CVE，相关细节请以官方安全公告为准）
...
### 安全认证
- https://security.googleblog.com/2025/08/Android-pKVM-Certified-SESIP-Level-5.html — pKVM SESIP 认证相关（未验证链接，内容待确认）
