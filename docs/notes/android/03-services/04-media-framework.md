...
### 7.1 关联章节
- [4x02 - seccomp-bpf](/notes/android/04-native/03-seccomp) - 媒体进程的系统调用过滤
- [5x02 - Kernel Attack Surface](/notes/android/05-kernel/03-attack-surface) - 多媒体驱动ioctl攻击面
- [3x00 - system_server架构](/notes/android/03-services/01-system-server) - 媒体服务与系统服务的交互边界
