...
- [技术笔记](/notes/)
  - [Android Internals](/notes/android/)
    ...
    - [2x00 Binder 深度解析](/notes/android/02-ipc/01-binder-deep-dive)
    - [2x01 Intent 系统安全](/notes/android/02-ipc/02-intent-system)
    - [2x02 HIDL 与 AIDL](/notes/android/02-ipc/03-hidl-aidl)
    - [2x03 其他 IPC 机制](/notes/android/02-ipc/04-other-ipc)
    - [Part 3: 系统服务](/notes/android/03-services/)
    - [3x00 system_server 架构](/notes/android/03-services/01-system-server)
    - [3x01 AMS 深度解析](/notes/android/03-services/02-ams)
    - [3x02 PMS 深度解析](/notes/android/03-services/03-pms)
    - [3x03 WMS 深度解析](/notes/android/03-services/04-wms)
    - [3x04 媒体框架安全](/notes/android/03-services/05-media-framework)
    - [Part 4: 原生层安全](/notes/android/04-native/)
    - [4x00 Bionic Libc](/notes/android/04-native/01-bionic-libc)
    - [4x01 Linker 链接器](/notes/android/04-native/02-linker)
    - [4x02 Seccomp 机制](/notes/android/04-native/03-seccomp)
    - [4x03 ART 运行时](/notes/android/04-native/04-art-runtime)
    - [4x04 原生守护进程](/notes/android/04-native/05-native-daemons)
    - [Part 5: 内核安全](/notes/android/05-kernel/)
    - [5x00 内核概览](/notes/android/05-kernel/01-kernel-overview)
    - [5x01 SELinux](/notes/android/05-kernel/02-selinux)
    - [5x02 内核攻击面](/notes/android/05-kernel/03-attack-surface)
    - [5x03 内核缓解](/notes/android/05-kernel/04-mitigations)
    - [5x04 AVF](/notes/android/05-kernel/05-avf)
    - [5x05 可利用性评估与验证框架](/notes/android/05-kernel/06-exploitation)
    - [Part 6: 硬件安全](/notes/android/06-hardware/)
    - [6x00 TrustZone/TEE](/notes/android/06-hardware/01-trustzone)
    - [6x01 ARM CCA](/notes/android/06-hardware/02-arm-cca)
    - [6x02 AVB](/notes/android/06-hardware/03-avb)
    - [6x03 硬件 KeyStore](/notes/android/06-hardware/04-keystore)
    - [Part 7: 专题研究](/notes/android/07-special/)
    - [7x00 WebView](/notes/android/07-special/01-webview)
    - [7x01 Bluetooth](/notes/android/07-special/02-bluetooth)
    - [7x02 Connectivity](/notes/android/07-special/03-connectivity)
    - [Part 8: 实战研究](/notes/android/08-practical/)
    - [8x00 方法论](/notes/android/08-practical/01-methodology)
    - [8x01 调试与逆向](/notes/android/08-practical/02-debugging)
    - [8x02 可利用性评估与验证](/notes/android/08-practical/03-exploit-dev)
    - [8x03 Bug Bounty](/notes/android/08-practical/04-bug-bounty)
    - [8x04 CVE 案例研究](/notes/android/08-practical/05-cve-studies)
